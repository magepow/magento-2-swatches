...
[![Latest Stable Version](https://poser.pugx.org/magepow/swatches/v/stable)](https://packagist.org/packages/magepow/swatches)
[![Total Downloads](https://poser.pugx.org/magepow/swatches/downloads)](https://packagist.org/packages/magepow/swatches)
[![Daily Downloads](https://poser.pugx.org/magepow/swatches/d/daily)](https://packagist.org/packages/magepow/swatches)

## Download Magento 2 Swatches Extension
### Install via composer (recommend)
Run the following commands in Magento 2 root folder:
```
composer require magepow/swatches
